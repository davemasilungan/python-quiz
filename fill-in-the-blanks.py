...
it's been stored in a ___4___. ___3___ not only effects a ___4___ but also any ___5___s which refer
to the same ___4___.
...
# *** From the Code Review, I couldn't find the number "3" referenced as a magic number , but I replaced all instances of
# what I thought might be magic numbers and also changed how the function replaces the blanks in the quiz.
...
# of if too many failed attempts are made, user is prompted with "failed" message.
